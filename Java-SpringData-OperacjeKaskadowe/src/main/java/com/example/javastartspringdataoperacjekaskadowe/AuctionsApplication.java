package com.example.javastartspringdataoperacjekaskadowe;
...
public class AuctionsApplication {
    ...
    public static void main(String[] args) {
        ...
        removeCategoryById(categoryRepository,1L); // usuwanie kategoriii a takze aukcji poprzez zastosowanie
